...
| eslint-plugin-import              | intends to support linting of ES2015+ (ES6+) import/export syntax, <br /> prevent issues with misspelling of file paths and import names                 | [v2.29.\*](https://github.com/import-js/eslint-plugin-import)             |
